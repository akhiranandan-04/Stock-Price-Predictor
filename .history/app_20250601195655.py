    ...
    st.markdown(
        ...
        <div class="sidebar-card">
            ...
            <div class="social-icons">
                <a href="https://github.com/akhiranandan-04" target="_blank"><i class="fa fa-github"></i></a>
                <a href="https://www.linkedin.com/in/akhiranandan-kaithala-a46a86291/" target="_blank"><i class="fa fa-linkedin"></i></a>
                <a href="https://www.instagram.com/akhiranandan_04" target="_blank"><i class="fa fa-instagram"></i></a>
            </div>
        </div>
        """,
        unsafe_allow_html=True
