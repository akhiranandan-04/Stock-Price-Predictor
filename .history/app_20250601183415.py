...
final_df=pas_100_days.append(data_test, ignore_index=True)
...
y_preditced=model.predict(x)

scale_factor=1/scaler[0]
y_preditced=y_preditced*scale_factor
y=y*scale_factor
...
plt.plot(y_preditced, 'r', label = 'Predicted Price')
