...
with st.sidebar:
    st.markdown(
        ...
        <div class="sidebar-card">
            <h2>Kaithala Akhiranandan</h2>
            <p>Second-year B.Tech student in AI & ML at ACE Engineering College. Tech enthusiast passionate about AI, ML, Java, Python, and frontend development. Loves building interactive, aesthetic UIs.</p>

            <div class="social-icons">
                <a href="https://github.com/akhiranandan-04" target="_blank"><i class="fab fa-github"></i></a>
                <a href="https://www.linkedin.com/in/akhiranandan-kaithala-a46a86291/" target="_blank"><i class="fab fa-linkedin-in"></i></a>
                <a href="https://www.instagram.com/akhiranandan_04" target="_blank"><i class="fab fa-instagram"></i></a>
            </div>
        </div>
        """,
        unsafe_allow_html=True
